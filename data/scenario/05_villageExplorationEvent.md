...
- 例: 相談した相手が[村長]の場合
    - ```text
      ...
      　村の外から来た方は、好奇心旺盛な方が多く、とんでもないことをされることがよくあるので……この家を拠点にしていただいて、私が管理するという役割を負っているのです。
...
9. ```text
   ...
   後にはぽつんと、〇〇だけが取り残された。
   ```
10. -> [シナリオ.村探索](../04_villageExploration.html)
...
1. ```text
   ダムの小屋を調べたところ、ドアは鍵がかかっているが、どうやら窓は開いているようだ。
   ```
2. PLが窓から中に入る
...
8. 夜ではない場合
    - ```text
      ...
      「殺して……」
      ```
9. このイベント以降、[副長]の[好感度の変化量]が2倍になる（永続）
10. ->[シナリオ.村探索](../04_villageExploration.html)
